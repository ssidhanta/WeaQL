@AOSETTABLE CREATE TABLE address(
	@NORMALINTEGER addr_id int auto_increment not null,
...
CREATE TABLE author ( 
	...
	@NORMALSTRING a_bio varchar(500),
	PRIMARY KEY (a_id)
	);
...
@AUSETTABLE CREATE TABLE customer ( 
	@NORMALINTEGER c_id int auto_increment not null ,
...
@AOSETTABLE CREATE TABLE order_line ( 
	...
	@NORMALSTRING ol_comments varchar(100),
...
@AOSETTABLE CREATE TABLE orders ( 
	@NORMALINTEGER o_id int auto_increment not null,
...
@AUSETTABLE CREATE TABLE shopping_cart ( 
	@NORMALINTEGER sc_id int auto_increment not null,
