...
@AW create table customer (
	...
	FOREIGN KEY(c_w_id,c_d_id) @IR REFERENCES district(d_w_id,d_id)
)Engine=InnoDB;
...
@RW create table stock (
	...
	FOREIGN KEY(s_i_id) @IR REFERENCES item(i_id)
)Engine=InnoDB;

@AW create table order_line (
