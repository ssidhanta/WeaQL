...
public class TableDefinition
{
	...
	public TableDefinition(String name, String nameAlias, int tableId, boolean[] colsStr, String[] cols,
						   String[] colsAlias, String[] colsTempAlias, String[] pk, String[] pkAlias,
						   String[] pkTempAlias, String[] uqIndicesPlain)
	{
		this.name = name;
	...
	private void init()
	{
		...
		{
			colsOriginal[i] = ! colsPlain[i].startsWith(ScratchpadDefaults.SCRATCHPAD_COL_PREFIX);
			if(i != 0)
			{
