...
public class CSVMerger2
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(CSVMerger2.class);
	...
	public CSVMerger2(String basePath, int numberReplicas, List<String> clientsList, String jdbc, int numberEmulators)
	{
