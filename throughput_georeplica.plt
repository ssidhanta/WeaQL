...
set output 'throughput_georeplica.eps'
...
plot 'throughput_georeplica.csv' using 2:xticlabels(1) title 'with MYSQL Cluster'  with linespoints pointtype 5 pointsize 1, 'throughput_georeplica.csv' using 4:xticlabels(3) title 'With WeaQL'  with linespoints pointtype 2 pointsize 1;