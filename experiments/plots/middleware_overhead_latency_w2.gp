...
plot data1 every 4::1 using ($7):xtic(1) lc rgb '#006400' fs pattern 1 title 'WeaQL',\
data3 every 4::1 using ($7):xtic(1) lc rgb purple fs pattern 2 title 'Galera-Cluster',\
data2 every 4::1 using ($7):xtic(1) lc rgb orange fs pattern 4 title 'MySQL-Cluster'
