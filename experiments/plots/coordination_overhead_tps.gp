...
plot data1 every 2::1 using 1:($3/60) with linespoints ls 5 lc rgb '#006400' lw 1.0 ps 1.5 title 'Unique IDs',\
data2 every 2::1 using 1:($3/60) with linespoints ls 4 lc rgb red lw 1.0 ps 1.5 title 'Unique+Seq IDs'
