...
drop database if exists tpcc_crdt;
create database tpcc_crdt;
use tpcc_crdt;
...
-- Name: ix_new_orders; Type: INDEX; Schema: public; Owner: tpcc
--
...
-- ALTER TABLE new_orders ADD CONSTRAINT fkey_new_orderss_1 FOREIGN KEY(no_w_id,no_d_id,no_o_id) REFERENCES orders(o_w_id,o_d_id,o_id);
